	...
	*/
	...
	'backend' => [
		...
		'general' => [
			...
			'are_you_sure' => 'Are you sure you?',
			'are_you_sure_delete' => 'Are you sure you want to delete this user?',
			'are_you_sure_confirm' => 'Are you sure you want to change user status?',
			'are_you_sure_session' => 'Are you sure you want to clear the session?',
			'site_name' => 'Social Engine',
			'continue' => 'Continue',
			'member_since' => 'Member since',
			'minutes' => ' minutes',
			'search_placeholder' => 'Search...',
			'timeout' => 'You were automatically logged out for security reasons since you had no activity in ',
			'are_you_sure_restore' => 'Are you sure you want to restore this user?',
