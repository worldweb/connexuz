...
trait UserAttribute {
	...
	public function getClearSessionButtonAttribute() {
		if ($this->id != auth()->id() && config('session.driver') == 'database') {
			return '<a href="' . route('admin.auth.user.clear-session', $this) . '"
                 ...
                 data-trans-title="' . __('strings.backend.general.are_you_sure_session') . '"
	...
	public function getDeleteButtonAttribute() {
		if ($this->id != auth()->id() && $this->id != 1) {
			return '<a href="' . route('admin.auth.user.destroy', $this) . '"
                 ...
                 data-trans-title="' . __('strings.backend.general.are_you_sure_delete') . '"
	...
	public function getRestoreButtonAttribute() {
		...
		name="confirm_item" 
		data-trans-title="' . __('strings.backend.general.are_you_sure_restore') . '"
		class="btn btn-info"><i class="fas fa-refresh" data-toggle="tooltip" data-placement="top" title="' . __('buttons.backend.access.users.restore_user') . '"></i></a> ';
	}
